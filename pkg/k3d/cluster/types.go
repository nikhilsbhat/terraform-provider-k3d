...
type Cluster interface {
	GetClusters(ctx context.Context, runtime runtimes.Runtime, clusterList []string) ([]*Config, error)
	StartStopCluster(ctx context.Context, runtime runtimes.Runtime, clusterList []string) error
}
